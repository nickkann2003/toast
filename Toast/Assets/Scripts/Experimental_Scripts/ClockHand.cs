...
public class ClockHand : MonoBehaviour
{
    ...
    private void SetSnapPoints()
    {
        ...
        snapPoints[0] = 0;
        float angle = 360 * 2 / (numSnapPoints - 1);
    ...
    {
        // Needs fixing
        transform.RotateAround(clockBody.transform.position, clockBody.transform.up, Vector3.Angle(Vector3.Normalize(Input.mousePosition), Camera.main.WorldToScreenPoint(clockBody.transform.position)));
        ...
        /*
            ...
            if (Mathf.Abs(rotation.z) > 360)
            {
                rotation.z = 360 * rotation.z / Mathf.Abs(rotation.z);
            }
            ...
            dialValue = (rotation.z + 360) / (360 * 2);
