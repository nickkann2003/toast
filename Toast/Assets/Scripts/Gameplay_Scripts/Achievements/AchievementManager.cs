...
public class AchievementManager : MonoBehaviour
{
    ...
    public Achievement
        ...
        ACHIEVEMENT_DETERGENT_EAT,
        ACHIEVEMENT_OVEN_COMPLETE,
        ACHIEVEMENT_FRIDGE_COMPLETE,
        ACHIEVEMENT_SINK_COMPLETE,
        ACHIEVEMENT_TOASTER_COMPLETE,
        ACHIEVEMENT_LITTLE_FELLA_COMPLETE,
    ...
    /// <summary>
    /// Achievement relating to unlocking the bagel button
    /// </summary>
